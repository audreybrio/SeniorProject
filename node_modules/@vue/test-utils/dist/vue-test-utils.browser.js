...
var VueTestUtils = (function (exports, Vue, compilerDom) {
    ...
    **/
    ...
    function mount(inputComponent, options) {
        ...
        var props = Vue.shallowReactive(__assign(__assign(__assign(__assign({}, options === null || options === void 0 ? void 0 : options.attrs), options === null || options === void 0 ? void 0 : options.propsData), options === null || options === void 0 ? void 0 : options.props), { ref: MOUNT_COMPONENT_REF }));
