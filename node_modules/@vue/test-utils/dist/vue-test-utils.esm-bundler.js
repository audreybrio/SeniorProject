...
/**
 * @vue/test-utils v2.0.0-rc.21
 * (c) 2022 Lachlan Miller
 * Released under the MIT License
 */

import * as Vue from 'vue';
import { transformVNodeArgs, Transition, BaseTransition, defineComponent, h, TransitionGroup, Teleport, nextTick, setDevtoolsHook, shallowReactive, createApp, computed } from 'vue';
...
function mount(inputComponent, options) {
    ...
    var props = shallowReactive(__assign(__assign(__assign(__assign({}, options === null || options === void 0 ? void 0 : options.attrs), options === null || options === void 0 ? void 0 : options.propsData), options === null || options === void 0 ? void 0 : options.props), { ref: MOUNT_COMPONENT_REF }));
